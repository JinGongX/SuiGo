import {
  markdown
} from "./chunk-A3M7FZMH.js";
import "./chunk-HXA36LO2.js";
import "./chunk-KKYIGX63.js";
import {
  autocompletion,
  closeBrackets,
  closeBracketsKeymap,
  completionKeymap
} from "./chunk-5WWR6CE4.js";
import "./chunk-2ZY7QL7I.js";
import {
  Annotation,
  ChangeDesc,
  ChangeSet,
  ...
  syntaxTree,
  tags
} from "./chunk-PUESBGKS.js";
import "./chunk-67Y2SD4W.js";
import {
  Fragment,
  Teleport,
  cloneVNode,
...
function sql(dialectName) {
  return import("./dist-L7EAW7XO.js").then((m) => m.sql({ dialect: m[dialectName] }));
}
var languages = [
  ...
  LanguageDescription.of({
    ...
    extensions: ["c", "h", "ino"],
    load() {
      return import("./dist-T2M4LHXK.js").then((m) => m.cpp());
    }
  }),
  LanguageDescription.of({
    name: "C++",
  ...
  LanguageDescription.of({
    ...
    extensions: ["css"],
    load() {
      return import("./dist-LR3QVPX5.js").then((m) => m.css());
    }
  }),
  LanguageDescription.of({
    name: "Go",
    extensions: ["go"],
    load() {
      return import("./dist-ICELKQS4.js").then((m) => m.go());
    }
  }),
  LanguageDescription.of({
    name: "HTML",
    ...
    load() {
      return import("./dist-T46NJMTI.js").then((m) => m.html());
    }
  }),
  LanguageDescription.of({
    name: "Java",
    extensions: ["java"],
    load() {
      return import("./dist-BG2RCYBS.js").then((m) => m.java());
    }
  }),
  LanguageDescription.of({
    name: "JavaScript",
    ...
    load() {
      return import("./dist-4JFEQIAQ.js").then((m) => m.javascript());
    }
  }),
  LanguageDescription.of({
    name: "JSON",
    ...
    extensions: ["json", "map"],
    load() {
      return import("./dist-TMKZVXXZ.js").then((m) => m.json());
    }
  }),
  LanguageDescription.of({
    name: "JSX",
    extensions: ["jsx"],
    load() {
      return import("./dist-4JFEQIAQ.js").then((m) => m.javascript({ jsx: true }));
    }
  }),
  LanguageDescription.of({
    name: "LESS",
    extensions: ["less"],
    load() {
      return import("./dist-OI42IJOR.js").then((m) => m.less());
    }
  }),
  LanguageDescription.of({
    name: "Liquid",
    extensions: ["liquid"],
    load() {
      return import("./dist-6SIFFH7H.js").then((m) => m.liquid());
    }
  }),
  LanguageDescription.of({
    name: "MariaDB SQL",
  ...
  LanguageDescription.of({
    ...
    load() {
      return import("./dist-BUCDHYOA.js").then((m) => m.markdown());
    }
  }),
  LanguageDescription.of({
    name: "MS SQL",
  ...
  LanguageDescription.of({
    ...
    load() {
      return import("./dist-5YOIHXJZ.js").then((m) => m.php());
    }
  }),
  LanguageDescription.of({
    name: "PLSQL",
  ...
  LanguageDescription.of({
    ...
    filename: /^(BUCK|BUILD)$/,
    load() {
      return import("./dist-K4KQAVUR.js").then((m) => m.python());
    }
  }),
  LanguageDescription.of({
    name: "Rust",
    extensions: ["rs"],
    load() {
      return import("./dist-MW5BQ6D4.js").then((m) => m.rust());
    }
  }),
  LanguageDescription.of({
    name: "Sass",
    extensions: ["sass"],
    load() {
      return import("./dist-DLXBU46V.js").then((m) => m.sass({ indented: true }));
    }
  }),
  LanguageDescription.of({
    name: "SCSS",
    extensions: ["scss"],
    load() {
      return import("./dist-DLXBU46V.js").then((m) => m.sass());
    }
  }),
  LanguageDescription.of({
    name: "SQL",
  ...
  LanguageDescription.of({
    ...
    extensions: ["tsx"],
    load() {
      return import("./dist-4JFEQIAQ.js").then((m) => m.javascript({ jsx: true, typescript: true }));
    }
  }),
  LanguageDescription.of({
    name: "TypeScript",
    ...
    load() {
      return import("./dist-4JFEQIAQ.js").then((m) => m.javascript({ typescript: true }));
    }
  }),
  LanguageDescription.of({
    name: "WebAssembly",
    extensions: ["wat", "wast"],
    load() {
      return import("./dist-762WUU2M.js").then((m) => m.wast());
    }
  }),
  LanguageDescription.of({
    name: "XML",
    ...
    load() {
      return import("./dist-KPW3AMYH.js").then((m) => m.xml());
    }
  }),
  LanguageDescription.of({
    name: "YAML",
    ...
    extensions: ["yaml", "yml"],
    load() {
      return import("./dist-ZDI57C6S.js").then((m) => m.yaml());
    }
  }),
  ...
  LanguageDescription.of({
    ...
    load() {
      return import("./apl-65E75FOD.js").then((m) => legacy(m.apl));
    }
  }),
  LanguageDescription.of({
    name: "PGP",
    ...
    load() {
      return import("./asciiarmor-NQIUHY7B.js").then((m) => legacy(m.asciiArmor));
    }
  }),
  LanguageDescription.of({
    name: "ASN.1",
    extensions: ["asn", "asn1"],
    load() {
      return import("./asn1-LSNWS4DT.js").then((m) => legacy(m.asn1({})));
    }
  }),
  LanguageDescription.of({
    name: "Asterisk",
    ...
    load() {
      return import("./asterisk-3CNG5DRF.js").then((m) => legacy(m.asterisk));
    }
  }),
  LanguageDescription.of({
    name: "Brainfuck",
    extensions: ["b", "bf"],
    load() {
      return import("./brainfuck-EIILRUT6.js").then((m) => legacy(m.brainfuck));
    }
  }),
  LanguageDescription.of({
    name: "Cobol",
    extensions: ["cob", "cpy"],
    load() {
      return import("./cobol-6CAFG4J3.js").then((m) => legacy(m.cobol));
    }
  }),
  LanguageDescription.of({
    name: "C#",
    ...
    extensions: ["cs"],
    load() {
      return import("./clike-VN6DYMG3.js").then((m) => legacy(m.csharp));
    }
  }),
  LanguageDescription.of({
    name: "Clojure",
    ...
    load() {
      return import("./clojure-J6MQZ3B6.js").then((m) => legacy(m.clojure));
    }
  }),
  LanguageDescription.of({
    name: "ClojureScript",
  ...
  LanguageDescription.of({
    ...
    extensions: ["gss"],
    load() {
      return import("./css-RBZZQQ7C.js").then((m) => legacy(m.gss));
    }
  }),
  LanguageDescription.of({
    name: "CMake",
    ...
    load() {
      return import("./cmake-OSAKZYYN.js").then((m) => legacy(m.cmake));
    }
  }),
  LanguageDescription.of({
    name: "CoffeeScript",
    ...
    extensions: ["coffee"],
    load() {
      return import("./coffeescript-TMSC7XVE.js").then((m) => legacy(m.coffeeScript));
    }
  }),
  LanguageDescription.of({
    name: "Common Lisp",
    ...
    load() {
      return import("./commonlisp-VUEVORYM.js").then((m) => legacy(m.commonLisp));
    }
  }),
  LanguageDescription.of({
    name: "Cypher",
    ...
    load() {
      return import("./cypher-GJ3VI52P.js").then((m) => legacy(m.cypher));
    }
  }),
  LanguageDescription.of({
    name: "Cython",
    ...
    load() {
      return import("./python-4JVD5NHK.js").then((m) => legacy(m.cython));
    }
  }),
  LanguageDescription.of({
    name: "Crystal",
    extensions: ["cr"],
    load() {
      return import("./crystal-C5JF7THV.js").then((m) => legacy(m.crystal));
    }
  }),
  LanguageDescription.of({
    name: "D",
    extensions: ["d"],
    load() {
      return import("./d-FVBZE2OY.js").then((m) => legacy(m.d));
    }
  }),
  LanguageDescription.of({
    name: "Dart",
    extensions: ["dart"],
    load() {
      return import("./clike-VN6DYMG3.js").then((m) => legacy(m.dart));
    }
  }),
  LanguageDescription.of({
    name: "diff",
    ...
    load() {
      return import("./diff-S7PRAZZL.js").then((m) => legacy(m.diff));
    }
  }),
  LanguageDescription.of({
    name: "Dockerfile",
    filename: /^Dockerfile$/,
    load() {
      return import("./dockerfile-INGPX26J.js").then((m) => legacy(m.dockerFile));
    }
  }),
  LanguageDescription.of({
    name: "DTD",
    extensions: ["dtd"],
    load() {
      return import("./dtd-X2555RHW.js").then((m) => legacy(m.dtd));
    }
  }),
  LanguageDescription.of({
    name: "Dylan",
    ...
    load() {
      return import("./dylan-NROFPAKD.js").then((m) => legacy(m.dylan));
    }
  }),
  LanguageDescription.of({
    name: "EBNF",
    load() {
      return import("./ebnf-I3TSVLFQ.js").then((m) => legacy(m.ebnf));
    }
  }),
  LanguageDescription.of({
    name: "ECL",
    extensions: ["ecl"],
    load() {
      return import("./ecl-3L276GYS.js").then((m) => legacy(m.ecl));
    }
  }),
  LanguageDescription.of({
    name: "edn",
  ...
  LanguageDescription.of({
    ...
    extensions: ["e"],
    load() {
      return import("./eiffel-BHO2DLXL.js").then((m) => legacy(m.eiffel));
    }
  }),
  LanguageDescription.of({
    name: "Elm",
    extensions: ["elm"],
    load() {
      return import("./elm-R6SRATMX.js").then((m) => legacy(m.elm));
    }
  }),
  LanguageDescription.of({
    name: "Erlang",
    extensions: ["erl"],
    load() {
      return import("./erlang-JA3E5NFO.js").then((m) => legacy(m.erlang));
    }
  }),
  LanguageDescription.of({
    name: "Esper",
    load() {
      return import("./sql-MI72T4SR.js").then((m) => legacy(m.esper));
    }
  }),
  LanguageDescription.of({
    name: "Factor",
    extensions: ["factor"],
    load() {
      return import("./factor-GPO26GR6.js").then((m) => legacy(m.factor));
    }
  }),
  LanguageDescription.of({
    name: "FCL",
    load() {
      return import("./fcl-3WEDL6HC.js").then((m) => legacy(m.fcl));
    }
  }),
  LanguageDescription.of({
    name: "Forth",
    ...
    load() {
      return import("./forth-KVRNSR74.js").then((m) => legacy(m.forth));
    }
  }),
  LanguageDescription.of({
    name: "Fortran",
    ...
    load() {
      return import("./fortran-4BTJN5X7.js").then((m) => legacy(m.fortran));
    }
  }),
  LanguageDescription.of({
    name: "F#",
    ...
    extensions: ["fs"],
    load() {
      return import("./mllike-JBSB5NMM.js").then((m) => legacy(m.fSharp));
    }
  }),
  LanguageDescription.of({
    name: "Gas",
    extensions: ["s"],
    load() {
      return import("./gas-FGKVVISF.js").then((m) => legacy(m.gas));
    }
  }),
  LanguageDescription.of({
    name: "Gherkin",
    extensions: ["feature"],
    load() {
      return import("./gherkin-RIETWJBT.js").then((m) => legacy(m.gherkin));
    }
  }),
  LanguageDescription.of({
    name: "Groovy",
    ...
    load() {
      return import("./groovy-ZSWYOUBS.js").then((m) => legacy(m.groovy));
    }
  }),
  LanguageDescription.of({
    name: "Haskell",
    extensions: ["hs"],
    load() {
      return import("./haskell-YAEL4NSX.js").then((m) => legacy(m.haskell));
    }
  }),
  LanguageDescription.of({
    name: "Haxe",
    extensions: ["hx"],
    load() {
      return import("./haxe-T5ELHUBU.js").then((m) => legacy(m.haxe));
    }
  }),
  LanguageDescription.of({
    name: "HXML",
    extensions: ["hxml"],
    load() {
      return import("./haxe-T5ELHUBU.js").then((m) => legacy(m.hxml));
    }
  }),
  LanguageDescription.of({
    name: "HTTP",
    load() {
      return import("./http-BPYEDCDE.js").then((m) => legacy(m.http));
    }
  }),
  LanguageDescription.of({
    name: "IDL",
    extensions: ["pro"],
    load() {
      return import("./idl-NOKKT3IN.js").then((m) => legacy(m.idl));
    }
  }),
  LanguageDescription.of({
    name: "JSON-LD",
    ...
    extensions: ["jsonld"],
    load() {
      return import("./javascript-BUG7HIIM.js").then((m) => legacy(m.jsonld));
    }
  }),
  LanguageDescription.of({
    name: "Jinja2",
    ...
    load() {
      return import("./jinja2-7BUSRXU7.js").then((m) => legacy(m.jinja2));
    }
  }),
  LanguageDescription.of({
    name: "Julia",
    extensions: ["jl"],
    load() {
      return import("./julia-X5PHU2JT.js").then((m) => legacy(m.julia));
    }
  }),
  LanguageDescription.of({
    name: "Kotlin",
    extensions: ["kt", "kts"],
    load() {
      return import("./clike-VN6DYMG3.js").then((m) => legacy(m.kotlin));
    }
  }),
  LanguageDescription.of({
    name: "LiveScript",
    ...
    extensions: ["ls"],
    load() {
      return import("./livescript-GS55FZU5.js").then((m) => legacy(m.liveScript));
    }
  }),
  LanguageDescription.of({
    name: "Lua",
    extensions: ["lua"],
    load() {
      return import("./lua-LJXJVPPS.js").then((m) => legacy(m.lua));
    }
  }),
  LanguageDescription.of({
    name: "mIRC",
    extensions: ["mrc"],
    load() {
      return import("./mirc-47SJEZKO.js").then((m) => legacy(m.mirc));
    }
  }),
  LanguageDescription.of({
    name: "Mathematica",
    ...
    load() {
      return import("./mathematica-IY4PNMZJ.js").then((m) => legacy(m.mathematica));
    }
  }),
  LanguageDescription.of({
    name: "Modelica",
    extensions: ["mo"],
    load() {
      return import("./modelica-G5DHZBZQ.js").then((m) => legacy(m.modelica));
    }
  }),
  LanguageDescription.of({
    name: "MUMPS",
    extensions: ["mps"],
    load() {
      return import("./mumps-MMB4EOEF.js").then((m) => legacy(m.mumps));
    }
  }),
  LanguageDescription.of({
    name: "Mbox",
    extensions: ["mbox"],
    load() {
      return import("./mbox-ZCLB3CVS.js").then((m) => legacy(m.mbox));
    }
  }),
  LanguageDescription.of({
    name: "Nginx",
    ...
    load() {
      return import("./nginx-GT2FKBQY.js").then((m) => legacy(m.nginx));
    }
  }),
  LanguageDescription.of({
    name: "NSIS",
    extensions: ["nsh", "nsi"],
    load() {
      return import("./nsis-N5CI5UQG.js").then((m) => legacy(m.nsis));
    }
  }),
  LanguageDescription.of({
    name: "NTriples",
    extensions: ["nt", "nq"],
    load() {
      return import("./ntriples-QZ2VZG3I.js").then((m) => legacy(m.ntriples));
    }
  }),
  LanguageDescription.of({
    name: "Objective-C",
    ...
    extensions: ["m"],
    load() {
      return import("./clike-VN6DYMG3.js").then((m) => legacy(m.objectiveC));
    }
  }),
  LanguageDescription.of({
    name: "Objective-C++",
    ...
    extensions: ["mm"],
    load() {
      return import("./clike-VN6DYMG3.js").then((m) => legacy(m.objectiveCpp));
    }
  }),
  LanguageDescription.of({
    name: "OCaml",
    ...
    load() {
      return import("./mllike-JBSB5NMM.js").then((m) => legacy(m.oCaml));
    }
  }),
  LanguageDescription.of({
    name: "Octave",
    extensions: ["m"],
    load() {
      return import("./octave-TLPWMNDV.js").then((m) => legacy(m.octave));
    }
  }),
  LanguageDescription.of({
    name: "Oz",
    extensions: ["oz"],
    load() {
      return import("./oz-F25LKVSC.js").then((m) => legacy(m.oz));
    }
  }),
  LanguageDescription.of({
    name: "Pascal",
    extensions: ["p", "pas"],
    load() {
      return import("./pascal-SIV3SMEL.js").then((m) => legacy(m.pascal));
    }
  }),
  LanguageDescription.of({
    name: "Perl",
    extensions: ["pl", "pm"],
    load() {
      return import("./perl-F3WS44WM.js").then((m) => legacy(m.perl));
    }
  }),
  LanguageDescription.of({
    name: "Pig",
    extensions: ["pig"],
    load() {
      return import("./pig-S5J7BT4E.js").then((m) => legacy(m.pig));
    }
  }),
  LanguageDescription.of({
    name: "PowerShell",
    ...
    load() {
      return import("./powershell-CQGFQ2TZ.js").then((m) => legacy(m.powerShell));
    }
  }),
  LanguageDescription.of({
    ...
    load() {
      return import("./properties-XEIZK6U7.js").then((m) => legacy(m.properties));
    }
  }),
  LanguageDescription.of({
    name: "ProtoBuf",
    extensions: ["proto"],
    load() {
      return import("./protobuf-VXLUS63U.js").then((m) => legacy(m.protobuf));
    }
  }),
  LanguageDescription.of({
    name: "Pug",
    ...
    extensions: ["pug", "jade"],
    load() {
      return import("./pug-DGPYHEAY.js").then((m) => legacy(m.pug));
    }
  }),
  LanguageDescription.of({
    name: "Puppet",
    extensions: ["pp"],
    load() {
      return import("./puppet-DLWQLJQU.js").then((m) => legacy(m.puppet));
    }
  }),
  LanguageDescription.of({
    name: "Q",
    extensions: ["q"],
    load() {
      return import("./q-CXWCZ3JI.js").then((m) => legacy(m.q));
    }
  }),
  LanguageDescription.of({
    name: "R",
    ...
    extensions: ["r", "R"],
    load() {
      return import("./r-GDFUG36I.js").then((m) => legacy(m.r));
    }
  }),
  LanguageDescription.of({
    name: "RPM Changes",
    load() {
      return import("./rpm-COOK7Y4O.js").then((m) => legacy(m.rpmChanges));
    }
  }),
  LanguageDescription.of({
    name: "RPM Spec",
    extensions: ["spec"],
    load() {
      return import("./rpm-COOK7Y4O.js").then((m) => legacy(m.rpmSpec));
    }
  }),
  LanguageDescription.of({
    name: "Ruby",
    ...
    load() {
      return import("./ruby-B2M5MU7U.js").then((m) => legacy(m.ruby));
    }
  }),
  LanguageDescription.of({
    name: "SAS",
    extensions: ["sas"],
    load() {
      return import("./sas-NUC52U6T.js").then((m) => legacy(m.sas));
    }
  }),
  LanguageDescription.of({
    name: "Scala",
    extensions: ["scala"],
    load() {
      return import("./clike-VN6DYMG3.js").then((m) => legacy(m.scala));
    }
  }),
  LanguageDescription.of({
    name: "Scheme",
    extensions: ["scm", "ss"],
    load() {
      return import("./scheme-N54PVM3V.js").then((m) => legacy(m.scheme));
    }
  }),
  LanguageDescription.of({
    name: "Shell",
    ...
    filename: /^PKGBUILD$/,
    load() {
      return import("./shell-5ZPRRTGP.js").then((m) => legacy(m.shell));
    }
  }),
  LanguageDescription.of({
    name: "Sieve",
    ...
    load() {
      return import("./sieve-MDQXZ4YO.js").then((m) => legacy(m.sieve));
    }
  }),
  LanguageDescription.of({
    name: "Smalltalk",
    extensions: ["st"],
    load() {
      return import("./smalltalk-NBV34T42.js").then((m) => legacy(m.smalltalk));
    }
  }),
  LanguageDescription.of({
    name: "Solr",
    load() {
      return import("./solr-W65EISZN.js").then((m) => legacy(m.solr));
    }
  }),
  LanguageDescription.of({
    name: "SML",
    ...
    load() {
      return import("./mllike-JBSB5NMM.js").then((m) => legacy(m.sml));
    }
  }),
  LanguageDescription.of({
    name: "SPARQL",
    ...
    load() {
      return import("./sparql-CW2DIJUP.js").then((m) => legacy(m.sparql));
    }
  }),
  LanguageDescription.of({
    name: "Spreadsheet",
    alias: ["excel", "formula"],
    load() {
      return import("./spreadsheet-7QWYPGVR.js").then((m) => legacy(m.spreadsheet));
    }
  }),
  LanguageDescription.of({
    name: "Squirrel",
    extensions: ["nut"],
    load() {
      return import("./clike-VN6DYMG3.js").then((m) => legacy(m.squirrel));
    }
  }),
  LanguageDescription.of({
    name: "Stylus",
    extensions: ["styl"],
    load() {
      return import("./stylus-SDFT6AFR.js").then((m) => legacy(m.stylus));
    }
  }),
  LanguageDescription.of({
    name: "Swift",
    extensions: ["swift"],
    load() {
      return import("./swift-XSO5B4IR.js").then((m) => legacy(m.swift));
    }
  }),
  LanguageDescription.of({
    name: "sTeX",
    load() {
      return import("./stex-SLWUGH6K.js").then((m) => legacy(m.stex));
    }
  }),
  LanguageDescription.of({
    name: "LaTeX",
  ...
  LanguageDescription.of({
    ...
    extensions: ["v", "sv", "svh"],
    load() {
      return import("./verilog-DH7AWGO5.js").then((m) => legacy(m.verilog));
    }
  }),
  LanguageDescription.of({
    name: "Tcl",
    extensions: ["tcl"],
    load() {
      return import("./tcl-XXDOTRQE.js").then((m) => legacy(m.tcl));
    }
  }),
  LanguageDescription.of({
    name: "Textile",
    extensions: ["textile"],
    load() {
      return import("./textile-JSIUTJAJ.js").then((m) => legacy(m.textile));
    }
  }),
  LanguageDescription.of({
    name: "TiddlyWiki",
    load() {
      return import("./tiddlywiki-MNFPU2DH.js").then((m) => legacy(m.tiddlyWiki));
    }
  }),
  LanguageDescription.of({
    name: "Tiki wiki",
    load() {
      return import("./tiki-RYD3GOMG.js").then((m) => legacy(m.tiki));
    }
  }),
  LanguageDescription.of({
    name: "TOML",
    extensions: ["toml"],
    load() {
      return import("./toml-2RLICFVT.js").then((m) => legacy(m.toml));
    }
  }),
  LanguageDescription.of({
    name: "Troff",
    ...
    load() {
      return import("./troff-KXM5LWHL.js").then((m) => legacy(m.troff));
    }
  }),
  LanguageDescription.of({
    name: "TTCN",
    ...
    load() {
      return import("./ttcn-YLX3ZLL3.js").then((m) => legacy(m.ttcn));
    }
  }),
  LanguageDescription.of({
    name: "TTCN_CFG",
    extensions: ["cfg"],
    load() {
      return import("./ttcn-cfg-SRBKSF4I.js").then((m) => legacy(m.ttcnCfg));
    }
  }),
  LanguageDescription.of({
    name: "Turtle",
    extensions: ["ttl"],
    load() {
      return import("./turtle-WOJ5N2PZ.js").then((m) => legacy(m.turtle));
    }
  }),
  LanguageDescription.of({
    name: "Web IDL",
    extensions: ["webidl"],
    load() {
      return import("./webidl-HMIN2RYM.js").then((m) => legacy(m.webIDL));
    }
  }),
  LanguageDescription.of({
    name: "VB.NET",
    extensions: ["vb"],
    load() {
      return import("./vb-FFFPQBGR.js").then((m) => legacy(m.vb));
    }
  }),
  LanguageDescription.of({
    name: "VBScript",
    extensions: ["vbs"],
    load() {
      return import("./vbscript-NM4RB25T.js").then((m) => legacy(m.vbScript));
    }
  }),
  LanguageDescription.of({
    name: "Velocity",
    extensions: ["vtl"],
    load() {
      return import("./velocity-OKNERJM2.js").then((m) => legacy(m.velocity));
    }
  }),
  LanguageDescription.of({
    name: "Verilog",
  ...
  LanguageDescription.of({
    ...
    extensions: ["vhd", "vhdl"],
    load() {
      return import("./vhdl-7ZYZ73S4.js").then((m) => legacy(m.vhdl));
    }
  }),
  LanguageDescription.of({
    name: "XQuery",
    ...
    load() {
      return import("./xquery-546JDHAB.js").then((m) => legacy(m.xQuery));
    }
  }),
  LanguageDescription.of({
    name: "Yacas",
    extensions: ["ys"],
    load() {
      return import("./yacas-Y6EI3FMF.js").then((m) => legacy(m.yacas));
    }
  }),
  LanguageDescription.of({
    name: "Z80",
    extensions: ["z80"],
    load() {
      return import("./z80-45JMMZXP.js").then((m) => legacy(m.z80));
    }
  }),
  LanguageDescription.of({
    name: "MscGen",
    ...
    load() {
      return import("./mscgen-SJQBZDTH.js").then((m) => legacy(m.mscgen));
    }
  }),
  LanguageDescription.of({
    name: "Xù",
    extensions: ["xu"],
    load() {
      return import("./mscgen-SJQBZDTH.js").then((m) => legacy(m.xu));
    }
  }),
  LanguageDescription.of({
    name: "MsGenny",
    extensions: ["msgenny"],
    load() {
      return import("./mscgen-SJQBZDTH.js").then((m) => legacy(m.msgenny));
    }
  }),
  LanguageDescription.of({
    name: "Vue",
    extensions: ["vue"],
    load() {
      return import("./dist-54WVRV7B.js").then((m) => m.vue());
    }
  }),
  LanguageDescription.of({
    name: "Angular Template",
    load() {
      return import("./dist-WZRL5JGN.js").then((m) => m.angular());
    }
  })
];
  ...
  static unsafeExposeInternals(c) {
    return {
      ...
      backgroundFetch: (k2, index2, options, context) => {
        var _a4;
        return __privateMethod(_a4 = c, _backgroundFetch, backgroundFetch_fn).call(_a4, k2, index2, options, context);
      },
      moveToTail: (index2) => {
        var _a4;
        return __privateMethod(_a4 = c, _moveToTail, moveToTail_fn).call(_a4, index2);
      },
      indexes: (options) => {
        var _a4;
  ...
  *rvalues() {
  ...
  set(k2, v, setOptions = {}) {
    ...
    if (this.maxEntrySize && size > this.maxEntrySize) {
      ...
      __privateMethod(this, _delete, delete_fn).call(this, k2, "set");
      return this;
    }
  ...
  async fetch(k2, fetchOptions = {}) {
    ...
    if (index2 === void 0) {
      if (status)
        status.fetch = "miss";
      const p = __privateMethod(this, _backgroundFetch, backgroundFetch_fn).call(this, k2, index2, options, context);
      ...
      if (__privateGet(this, _isStale).call(this, index2)) {
        ...
        if (!fetching) {
          if (!noDeleteOnStaleGet) {
            __privateMethod(this, _delete, delete_fn).call(this, k2, "expire");
          }
   ...
   */
  delete(k2) {
    return __privateMethod(this, _delete, delete_fn).call(this, k2, "delete");
  }
  /**
    ...
    if (__privateGet(this, _valList)[index2] === p) {
      if (v2 === void 0) {
        if (bf2.__staleWhileFetching) {
          ...
          __privateMethod(this, _delete, delete_fn).call(this, k2, "fetch");
        }
      } else {
        if (options.status)
    ...
    if (index2 !== void 0) {
      ...
      if (__privateGet(this, _size) === 1) {
        ...
        if (__privateMethod(this, _isBackgroundFetch, isBackgroundFetch_fn).call(this, v)) {
          ...
          if (__privateGet(this, _hasDisposeAfter)) {
            (_b = __privateGet(this, _disposed)) == null ? void 0 : _b.push([v, k2, reason]);
          }
        }
        __privateGet(this, _keyMap).delete(k2);
  ...
  onMounted(() => {
    ...
    if (/\.mjs/.test(jsSrc)) {
      ...
      appendHandler(
        "script",
        {
          ...(_b = editorExtensionsAttrs2.mermaid) == null ? void 0 : _b.js,
          src: jsSrc,
          id: `${prefix}-mermaid`,
          onload() {
...
var TaskListPlugin = githubTaskLists;
    ...
    return () => {
      ...
      return createVNode(MdModal, {
        ...
        default: () => {
          ...
          }, [((_a22 = ult.value.clipModalTips) == null ? void 0 : _a22.buttonUpload) || ((_b = ult.value.linkModalTips) == null ? void 0 : _b.buttonOK)])]), createVNode("input", {
            "ref": uploadRef,
            "accept": "image/*",
            "type": "file",
            "multiple": false,
